 ...
 * Use the {@link FragmentFloor2#newInstance} factory method to
...
public class FragmentFloor2 extends Fragment implements OnItemClickListener {
     ...
     * @return A new instance of fragment FragmentFloor2.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentFloor2 newInstance(String param1, String param2) {
        FragmentFloor2 fragment = new FragmentFloor2();
    ...
    void loadDataAdapterTable(){
        lstTable = lstTable.stream().filter(r -> r.getTableFloor() == 2).collect(Collectors.toList());
